...
class SimpleReply final :
 ...
 public:
  ...
  void set_runtimeerror(bool value);
  private:
  bool _internal_runtimeerror() const;
  void _internal_set_runtimeerror(bool value);
  public:
...
inline void SimpleReply::clear_runtimeerror() {
  _impl_.runtimeerror_ = false;
}
inline bool SimpleReply::_internal_runtimeerror() const {
  return _impl_.runtimeerror_;
}
inline bool SimpleReply::runtimeerror() const {
  // @@protoc_insertion_point(field_get:WJudger.SimpleReply.runtimeError)
  return _internal_runtimeerror();
}
inline void SimpleReply::_internal_set_runtimeerror(bool value) {
  
  _impl_.runtimeerror_ = value;
}
inline void SimpleReply::set_runtimeerror(bool value) {
